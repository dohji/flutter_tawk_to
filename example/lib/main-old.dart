...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              globalController.showTawk.value = !globalController.showTawk.value;
            },
          ),
        ],
      ),
      ...
      //     // Tawk widget, hidden or shown based on _showTawk
      //     Obx(() => Offstage(
      //         offstage: !globalController.showTawk.value,
      //         child: Tawk(
      ...
      //             },
      //           ),
      //           onAgentMessage: (String message) {
      //             // Handle agent message
      //             print("New Tawk Agent Message: $message");
      //           },
      //         ),
      //       ),
      //     ),
...
class _HelpScreenState extends State<HelpScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     TawkNotificationService()._showNotification(message);
      //   },
      // ),
    );
  }
...
void onDidReceiveNotificationResponse(NotificationResponse notificationResponse) async {
  ...
  try{
    Get.find<GlobalStateController>().showTawk.value = true;
  }catch (e) {
